                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('status_aktif') is-invalid @enderror" 
                                            ...
                                            <option value="1" {{ old('status_aktif', $vendor->status_aktif) == '1' ? 'selected' : '' }}>Aktif</option>
                                            <option value="0" {{ old('status_aktif', $vendor->status_aktif) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                                        </select>
                                        @error('status_aktif')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
